...
[source,groovy]
----
include::{projectdir}/src/spec/test/json/JsonTest.groovy[tags=parse_text,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/json/JsonTest.groovy[tags=parse_list,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/json/JsonTest.groovy[tags=parse_number,indent=0]
----
...
|number
|`java.lang.Double` or `java.lang.Integer`
...
[source,groovy]
----
include::{projectdir}/src/spec/test/json/JsonTest.groovy[tags=set_type,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/json/JsonTest.groovy[tags=json_output,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/json/JsonTest.groovy[tags=json_output_pogo,indent=0]
----
...
[source,groovy]
----
include::{projectdir}/src/spec/test/json/JsonTest.groovy[tags=pretty_print,indent=0]
----
