...
public class CompilationUnit extends ProcessingUnit {
    ...
    public void configure(CompilerConfiguration configuration) {
        ...
        if (!this.configured && this.classLoader != null) {
    ...
    public void applyToPrimaryClassNodes(PrimaryClassNodeOperation body) throws CompilationFailedException {
        for (ClassNode classNode1 : getPrimaryClassNodes(body.needSortedInput())) {
            SourceUnit context = null;
            try {
                context = classNode1.getModule().getContext();
                if (context == null || context.phase < phase || (context.phase == phase && !context.phaseComplete)) {
                    int offset = 1;
                    Iterator<InnerClassNode> iterator = classNode1.getInnerClasses();
                    while (iterator.hasNext()) {
                        iterator.next();
                        offset++;
                    }
                    body.call(context, new GeneratorContext(this.ast, offset), classNode1);
                }
            } catch (CompilationFailedException e) {
