 ...
 * <pre>
 * public class script1291741477073 extends groovy.lang.Script {*   Object counter = 0
 *
 *   public java.lang.Object run() {*     counter = 0
 *}*
 *   public java.lang.Object scriptMethod() {*     if (this.conditionalTransformXXXXXX$condition()) {*       throw new java.lang.InterruptedException('Execution interrupted. The following condition failed: { counter++> 10}')
 *}*     4.times({*       if (this.conditionalTransformXXXXXX$condition()) {*         throw new java.lang.InterruptedException('Execution interrupted. The following condition failed: { counter++> 10}')
 *}*       this.println('executing script method...')
 *})
 *}*
 *   private java.lang.Object conditionalTransformXXXXXX$condition() {*     counter++ > 10
 *}*}* </pre>
 *
 ...
 * def counter = 0
 * <code>@ConditionalInterrupt({ counter++> 10})</code>
 * class MyClass {*   def myMethod() {*     4.times {*       println 'executing script method...'
 *}*}*}*
